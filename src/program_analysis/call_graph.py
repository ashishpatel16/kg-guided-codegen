...
def visualize_dynamic_graph(graph_data: Dict[str, Any], output_path: str = "dynamic_call_graph.png"):
    G = nx.DiGraph()
...
if __name__ == "__main__":
    ...
    print(f"Dynamic call graph saved to {output_graph_file} with {len(graph['nodes'])} nodes and {len(graph['edges'])} edges.")
